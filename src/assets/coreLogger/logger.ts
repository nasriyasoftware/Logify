...
import { ScheduledTask } from 'nasriya-cron/src/assets/docs';
    ...
    private readonly _handlers = {
        exitHandlers: {
            ...
            killedExit: async () => {
                ...
                const task: ScheduledTask = nasriyaCron.getTask('LogifyWriting') as ScheduledTask;
                if (task) { task.stop() }
